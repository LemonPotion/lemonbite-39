...
const About = () => {
  ...
  const techStacks = {
    backend: [
      { name: "ASP.NET Core", description: "Современный кроссплатформенный веб-фреймворк", icon: <Server className="text-[#202020]" size={40} /> },
      { name: "Entity Framework Core", description: "Современная ORM для .NET", icon: <Database className="text-[#202020]" size={40} /> },
      { name: ".NET 8", description: "Новейшая платформа .NET", icon: <Code className="text-[#202020]" size={40} /> },
      { name: "PostgreSQL", description: "Продвинутая база данных с открытым исходным кодом", icon: <Database className="text-[#202020]" size={40} /> },
      { name: "MediatR", description: "Реализация паттерна CQRS", icon: <Layers className="text-[#202020]" size={40} /> },
      { name: "AutoMapper", description: "Решение для маппинга объектов", icon: <FileCode className="text-[#202020]" size={40} /> }
    ],
    frontend: [
      { name: "React 18", description: "Современная UI библиотека", icon: <Laptop className="text-[#202020]" size={40} /> },
      { name: "TypeScript", description: "Типизированный JavaScript", icon: <Terminal className="text-[#202020]" size={40} /> },
      { name: "Tailwind CSS", description: "CSS фреймворк основанный на утилитах", icon: <FileCode className="text-[#202020]" size={40} /> },
      { name: "React Query", description: "Библиотека для получения данных", icon: <Link className="text-[#202020]" size={40} /> },
      { name: "Framer Motion", description: "Библиотека анимаций", icon: <ChartBar className="text-[#202020]" size={40} /> },
      { name: "shadcn/ui", description: "Библиотека UI компонентов", icon: <Layers className="text-[#202020]" size={40} /> }
    ]
  };
    ...
    <div className="min-h-screen bg-[#202020] flex flex-col relative">
      ...
      >
        <div className="bg-[#202020] border border-[#F98553] rounded-[3rem] px-8 py-12 max-w-4xl w-[90vw] mx-auto relative hover:border-opacity-100 transition-all duration-300">
          ...
          >
            Шаблон Full-Stack с Открытым Исходным Кодом
          </motion.h1>
          <motion.p 
            className="mt-6 text-xl md:text-2xl text-[#CECCC5] text-center max-w-2xl mx-auto font-light"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.4, duration: 0.5 }}
          >
            Современный высокопроизводительный шаблон веб-приложения, созданный на .NET 8 и React
          </motion.p>
        </div>
      </motion.section>
      ...
      >
        <div className="bg-[#202020] border border-[#F98553] rounded-3xl shadow-lg p-8 overflow-hidden relative">
          <div className="relative z-10 flex flex-col items-center text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-[#F98553] mb-6">Начните Разработку Сегодня</h2>
            <p className="text-[#CECCC5] text-lg max-w-2xl mb-8 font-light">
              Исследуйте наш шаблон с открытым исходным кодом и создавайте современные, масштабируемые веб-приложения, следуя лучшим практикам индустрии.
            </p>
            <RouterLink to="https://github.com" target="_blank">
              <motion.button
                className="px-8 py-3 bg-[#F98553] text-[#202020] font-bold rounded-full flex items-center gap-2 hover:bg-[#F98553]/90 transition-colors"
