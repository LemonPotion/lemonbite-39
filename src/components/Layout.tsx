...
const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-background to-muted/30 theme-transition relative overflow-hidden">
      ...
      {/* Add navigation buttons only on home page */}
      {isHomePage && (
        <div className="fixed bottom-6 left-6 flex flex-col gap-3 z-10">
          <Link 
            to="/about"
            className="px-4 py-2 bg-accent/90 text-white rounded-full shadow-lg hover:bg-accent transition-all duration-300 hover:scale-105 text-sm font-medium"
          >
            О нас
          </Link>
        </div>
