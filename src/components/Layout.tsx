  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-background to-muted/30 theme-transition relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full -z-10 opacity-20 dark:opacity-10" ref={bgRef}>
        ...
        <div className="absolute top-20 left-24 w-10 h-10 rounded-full bg-accent/50 animate-float" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute top-40 left-10 w-16 h-16 rounded-full bg-muted/70 animate-float" style={{ animationDelay: '1.7s' }}></div>
        ...
        <div className="absolute top-24 right-24 w-12 h-12 bg-accent/60 transform rotate-45 animate-float" style={{ animationDelay: '1.2s' }}></div>
        <div className="absolute top-48 right-16 w-14 h-14 rounded-full border-2 border-muted/70 animate-float" style={{ animationDelay: '0.9s' }}></div>
        
        {/* Bottom left shapes */}
        <div className="absolute bottom-10 left-10 w-14 h-14 rounded-full border-4 border-accent animate-float" style={{ animationDelay: '0.3s' }}></div>
        <div className="absolute bottom-24 left-24 w-8 h-8 bg-primary/70 rounded-full animate-float" style={{ animationDelay: '0.9s' }}></div>
        <div className="absolute bottom-56 left-16 w-16 h-16 rounded-full border-2 border-accent/60 animate-float" style={{ animationDelay: '1.5s' }}></div>
        
        {/* Bottom right shapes */}
        <div className="absolute bottom-10 right-15 w-12 h-12 border-4 border-accent transform rotate-45 animate-float" style={{ animationDelay: '0.6s' }}></div>
        <div className="absolute bottom-24 right-24 w-8 h-8 bg-primary/70 rounded-full animate-float" style={{ animationDelay: '1.1s' }}></div>
        <div className="absolute bottom-48 right-10 w-14 h-14 transform rotate-12 border-2 border-muted animate-float" style={{ animationDelay: '0.8s' }}></div>
        
        {/* More center shapes for a fuller background */}
        <div className="absolute top-1/3 left-1/4 w-20 h-20 rounded-full border border-primary/30 animate-float" style={{ animationDelay: '1.3s' }}></div>
        <div className="absolute top-2/3 right-1/3 w-16 h-16 rounded-full border border-accent/30 animate-float" style={{ animationDelay: '0.4s' }}></div>
        <div className="absolute top-1/2 left-1/2 w-24 h-24 rounded-full border-2 border-primary/20 animate-float" style={{ animationDelay: '2.1s' }}></div>
        <div className="absolute top-1/4 right-1/4 w-18 h-18 rounded-full border-2 border-accent/20 animate-float" style={{ animationDelay: '1.8s' }}></div>
      </div>
